...
const PoseView = ({ connectionId, schemaId, args }: { connectionId?: number, schemaId?: number, args: any[] }) => {
    ...
    const latest = n > 0 ? { 'x': data[n-1][args[0]], 'y': data[n-1][args[1]], 'theta': data[n-1][args[2]] } : null;
